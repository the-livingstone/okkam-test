...
OVERLAP_0_33 = "audience1=" + urllib.parse.quote("Sex = 2") + "&audience2=" + urllib.parse.quote("Age = 20")
AUDIENCE1_EMPTY = "audience1=" + urllib.parse.quote("Age > 90") + "&audience2=" + urllib.parse.quote("Sex = 1")
AUD1_FULL_IN_AUD2 = "audience1=" + urllib.parse.quote("Age > 30") + "&audience2=" + urllib.parse.quote("Age > 10")
AUD1_NO_OVERLAP_AUD2 = "audience1=" + urllib.parse.quote("Sex = 2") + "&audience2=" + urllib.parse.quote("Age = 50")
...
def test_audience1_empty(test_client: TestClient):
    response = get_json(test_client.get(f"/getPercent?{AUDIENCE1_EMPTY}"), status_code=422)
